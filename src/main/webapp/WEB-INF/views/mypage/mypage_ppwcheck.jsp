...
<link rel="stylesheet" href="${pageContext.request.contextPath}/style/mypage/mypage_ppwcheck.css">
...
<body>
    <div class="container">
        ...
        <form method="post" action="${pageContext.request.contextPath}/ppassword_yn">
            <div class="form-group">
                <input type="password" id="ppass" name="ppass" required placeholder="비밀번호를 입력해주세요">
