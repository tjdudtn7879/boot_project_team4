...
<head>
    ...
    <title>CODNECT</title>
    <link rel="stylesheet" href="${pageContext.request.contextPath}/style/login/pwfind.css">
...
<body>
    ...
    <div class="container">
        ...
        <form method="post" id="generalForm" class="visible" action="${pageContext.request.contextPath}/ppwchange">
            ...
            <!-- 이메일 인증 -->
                일반회원 이메일<input type="text" id="email" name="email" placeholder="Email을 입력해주세요" >
                ...
                <button type="button" onclick="pverifyCode()"class="mail_ck">확인</button>
        ...
        <form method="post" id="businessForm" action="${pageContext.request.contextPath}/cpwchange">
			...
			아이디<input type="text" name="cuserid" placeholder="아이디를 입력해주세요" required><br>
			사업자 번호<input type="text" name="bsnum" placeholder="사업자번호를 입력해주세요" required><br>
			<!-- 이메일 인증 -->
